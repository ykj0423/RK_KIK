  ...
  <form role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <div class="form-group">
      <table id="regist" align="center" class="table table-bordered table-condensed  form-inline f120" >
        ...
        <tr>
          <th>代表者TEL<span class="red">(必須)</span></th>
          <td>
              <input type="text" name="tel1_1" class="short mr10" value="" maxlength="5">-
              <input type="text" name="tel1_2" class="short mr10"  value="" maxlength="5">-
              <input type="text" name="tel1_3" class="short mr10"  value="" maxlength="5">
        ...
        <tr>
          <th>代表者メールアドレス<span class="red">(必須)</span><br></th>
          <td>
        ...
        <tr>
          <th>連絡者TEL<span class="red"></span></th>
          <td>
        ...
        <tr>
          <th>連絡者メールアドレス<span class="red"></span><br></th>
          <td>
            <span class="text-danger">
              <!-- ※ご登録いただいたメールアドレスあてに「利用者登録完了メール」が送付されます。<br>
              また、今後、施設の使用をお申し込みの際は、予約受付やお支払に関するメールが送付されます。<br>
